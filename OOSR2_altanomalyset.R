########################################################
#
# This file provides how to obtain Out-of-sample R2 using alternative anomaly set 
#
########################################################
...
actual = read.csv('./Forecast/actual_alt.csv')

# Convert date variable to date format
actual$date = as.Date(actual$date)

# Benchmark forecasts
forecastPm = read.csv('./Forecast/forecastPm_alt.csv')
