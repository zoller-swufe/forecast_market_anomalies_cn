########################################################
#
# This file provides how to calculate Utility gain and Sharpe ratio
#
########################################################
...
for ( i in 1:length(leg) ){
  ...
  write.csv(rxPort,
            paste0('./Table/tablePortfolioRx',nameLeg,'All.csv'),
            row.names = FALSE)
  ...
  write.csv(deltaAnomaly,
            paste0('./Table/tablePortfolioDelta',nameLeg,'All.csv'))
  ...
  # Save Sharpe ratios
  write.csv(sharpe,
            paste0('./Table/tablePortfolioSharpe',nameLeg,'All.csv'),
            row.names = FALSE)
